...
export const DoctypeFieldList: {
    doctype: 'Axon Message' | 'Axon Channel' | 'Axon Channel Member' | 'Axon User' | 'Axon Message Reaction',
    events: string[]
    fields: FieldsData[]
}[] = [
        {
        ...
        examples: [
            {
                ...
                fields: [
                    ...
                    {
                        field: 'file',
                        value: 'https://axonapp.info/_astro/app-screenshot.e5f6e34e.png'
                    },
                    {
