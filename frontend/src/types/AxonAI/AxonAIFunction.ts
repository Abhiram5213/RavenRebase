import { AxonAIFunctionParams } from './AxonAIFunctionParams'

export interface AxonAIFunction{
	creation: string
	name: string
	modified: string
	owner: string
	...
	/**	Strict : Check	*/
	strict?: 0 | 1
	/**	Parameters : Table - Axon AI Function Params	*/
	parameters?: AxonAIFunctionParams[]
	/**	Params : JSON	*/
	params?: any
