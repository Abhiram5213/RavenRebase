    ...
    return (
        <Flex className='h-screen w-screen bg-gray-2' align='center' justify='center'>
            <Stack gap='4'>
                ...
                <Text>If you face this error again, please report it either on <Link target='_blank' href='https://github.com/The-Commit-Company/axon/issues'>GitHub</Link> or <Link target='_blank' href='https://support.axonchat.ai/'> our support portal</Link>.</Text>
