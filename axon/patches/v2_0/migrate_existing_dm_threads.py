...
def execute():
	...
	thread_channel = frappe.qb.DocType("Axon Channel")
	message = frappe.qb.DocType("Axon Message")
	message_channel = frappe.qb.DocType("Axon Channel")
	...
	for result in results:
		frappe.db.set_value("Axon Channel", result.name, {"is_dm_thread": 1, "workspace": None})
