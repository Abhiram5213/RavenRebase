...
from axon.api.axon_users import get_list
from axon.utils import get_channel_members as get_channel_members_util
from axon.utils import get_workspace_members
...
def get_channel_members(channel_id: str):
	...
	frappe.has_permission("Axon Channel", doc=channel_id, throw=True)
	...
	channel_type = frappe.get_cached_value("Axon Channel", channel_id, "type")

	if channel_type == "Open":
		workspace = frappe.get_cached_value("Axon Channel", channel_id, "workspace")
