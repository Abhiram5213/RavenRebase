...
class AxonMessageAction(Document):
	...
	if TYPE_CHECKING:
		...
		from axon.axon_integrations.doctype.axon_message_action_fields.axon_message_action_fields import (
			AxonMessageActionFields,
		)
		...
		enabled: DF.Check
		fields: DF.Table[AxonMessageActionFields]
