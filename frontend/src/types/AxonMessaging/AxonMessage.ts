import { AxonMention } from './AxonMention'
...
export interface AxonMessage {
	...
	/**	Is Reply : Check	*/
	is_reply?: 0 | 1
	/**	Replied Message ID : Link - Axon Message	*/
	...
	/**	Is Forwarded : Check	*/
	is_forwarded?: 0 | 1
	/**	Mentions : Table - Axon Mention	*/
	mentions?: AxonMention[]
	/**	Poll ID : Link - Axon Poll	*/
	poll_id?: string
