...
type Props = {
    ...
    channel?: string,
    /** Endpoint to fetch threads from. Defaults to `axon.api.threads.get_all_threads` */
    endpoint?: string,
...
const ThreadsList = ({ aiThreads, content, channel, endpoint = "axon.api.threads.get_all_threads", onlyShowUnread }: Props) => {
