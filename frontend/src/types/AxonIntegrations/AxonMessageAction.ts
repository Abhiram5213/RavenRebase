import { AxonMessageActionFields } from './AxonMessageActionFields'

export interface AxonMessageAction{
	creation: string
	name: string
	modified: string
	owner: string
	...
	/**	Fields : Table - Axon Message Action Fields	*/
	fields?: AxonMessageActionFields[]
}