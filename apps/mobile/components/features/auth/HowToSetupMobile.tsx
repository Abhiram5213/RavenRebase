    ...
    return (
        <View>
            <TouchableOpacity className='flex-row items-center gap-1' onPress={onPress}>
                ...
                <Text className='text-sm text-muted-foreground'>How do I setup my site for Axon mobile?</Text>
            </TouchableOpacity>
...
const HowToSetupMobileContent = ({ onDismiss }: { onDismiss: () => void }) => {
    ...
    return <View className='p-4 flex gap-4'>
        <Text className='text-lg text-foreground font-semibold'>Set up Axon mobile on your site</Text>
        <View className='flex gap-2'>
            <Text className='text-base text-foreground'>
                <StepNumber number={1} /> Open Axon on your desktop browser
            </Text>
            <Text className='text-base text-foreground'>
