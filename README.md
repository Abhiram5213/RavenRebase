<p align="center">
  <a href="https://github.com/The-Commit-Company/axon">
  <img src="axon_logo.png" alt="Axon logo" height="100" />
     </a>
   <hr />
  <p align="center">Enterprise-first messaging platform that seamlessly integrates with your ERP
     <br />
    <br />
    <a href="https://frappecloud.com/dashboard/signup?product=axon"><strong>Install on Frappe Cloud</strong></a>
    <br />
    <a href="https://axonchat.ai">Website (axonchat.ai)</a>
    <br />
    <a href="https://github.com/The-Commit-Company/axon/issues">Issues</a>
    ·
    <a href="https://community.axonapp.cloud">Community & Support</a>
     ·
...
<p align="center">
  <a href="https://github.com/The-Commit-Company/Axon/blob/main/LICENSE">
    <img alt="license" src="https://img.shields.io/badge/license-AGPLv3-blue">
  </a>
     <a href="https://github.com/The-Commit-Company/axon/stargazers"><img src="https://img.shields.io/github/stars/The-Commit-Company/axon" alt="Github Stars"></a>
     <a href="https://github.com/The-Commit-Company/axon/pulse"><img src="https://img.shields.io/github/commit-activity/m/The-Commit-Company/axon" alt="Commits-per-month"></a>
</p>

<p align="center">
<img src="screenshots/AxonUIGraphic.png" alt="A graphic showing how the Axon interface looks on the web" />
</p>


​Axon is an open-source messaging platform that brings your team's conversations and information into one centralized place, enhancing collaboration and productivity. Whether you're at your desk or on the move, Axon keeps you connected on any device.​
...
5. **Integrate Seamlessly:**  Axon works effortlessly with other Frappe apps, allowing you to share documents from ERPNext with customizable previews, trigger notifications based on document events, perform workflow actions and, print documents directly within chats.​
...
<div>
	<a href="https://frappecloud.com/dashboard/signup?product=axon" target="_blank">
		<picture>
...
Follow these steps to set up Axon in production:
...
python3 ./easy-install.py deploy \
    --project=axon_prod_setup \
    --email=your_email.example.com \
    --image=ghcr.io/the-commit-company/axon \
    --version=stable \
    --app=axon \
...
- `subdomain.domain.tld`: Your domain name where Axon will be hosted

The script will set up a production-ready instance of Axon with all the necessary configurations in about 5 minutes.
...
> First run takes ~5 minutes — it installs Frappe, builds the frontend, and sets up the database automatically.

**Step 3**: The site [http://axon.localhost:8000/axon](http://axon.localhost:8000/axon) should now be available. The default credentials are:
...
```bash
bench new-site axon.test
```
4. Map your site to localhost with the command 
```bash
bench --site axon.test add-to-hosts
```
5. Download the Axon app. Run 
```bash
bench get-app https://github.com/The-Commit-Company/axon
```
6. Install the app on the site 
```bash
bench --site axon.test install-app axon
```
7. Now open the URL `http://axon.test:8000/axon` in your browser, you should see the app running
...
```bash
bench --site axon.test set-config ignore_csrf 1
```


##### Web App

Axon's **web app** is a React based single page app located in the `/frontend` directory. It uses Vite to compile the app.
If you want to make changes to the frontend with hot reloading, follow the steps below:

1. Navigate to the apps/axon folder in your bench directory
```bash
cd apps/axon
```
...
VITE_SITE_NAME='axon.test' # This is the same of the site
```


##### Mobile App

Axon's **mobile app** is a React Native based app built using Expo. It requires an [Expo Development Build](https://docs.expo.dev/develop/development-builds/introduction/) and will not run on Expo Go.
...
Axon features a comprehensive test suite covering the backend, frontend, and mobile applications.

### Backend (Frappe)

Backend tests use the Frappe Framework's testing utility. To run all tests for the Axon app:

```bash
docker exec -w /home/frappe/frappe-bench axon-frappe-1 bench --site axon.localhost run-tests --app axon
```

### Frontend (Web)

Frontend tests are built with [Vitest](https://vitest.dev/).
...
> **Note**: Frontend testing requires Node 20 or higher due to dependencies like `@livekit/react-native`.

### Mobile (Expo)

Mobile tests use [Jest](https://jestjs.io/) with `jest-expo`.
...
- [Community Forum & Support](https://community.axonapp.cloud)
...
<a href="https://github.com/The-Commit-Company/axon/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=The-Commit-Company/axon" />
</a>


## Reporting Bugs
If you find any bugs, feel free to report them here on [GitHub Issues](https://github.com/The-Commit-Company/axon/issues). Make sure you share enough information (app screenshots, browser console screenshots, stack traces, etc) for project maintainers to replicate your bug.
