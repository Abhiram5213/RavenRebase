...
const CustomEmojiList = () => {
    ...
    const { data, isLoading, error, mutate } = useFrappeGetDocList<AxonCustomEmoji>("Axon Custom Emoji", {
...
const CustomEmojisTable = ({ emojis, onDelete }: { emojis: AxonCustomEmoji[], onDelete: () => void }) => {
    return (
