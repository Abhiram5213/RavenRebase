import { AxonPinnedMessages } from '../Axon/AxonPinnedMessages'

export interface AxonChannel{
	creation: string
	name: string
	modified: string
	owner: string
	...
	/**	Pinned Messages : Table - Axon Pinned Messages	*/
	pinned_messages?: AxonPinnedMessages[]
